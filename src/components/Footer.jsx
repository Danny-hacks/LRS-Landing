        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="mb-5 inline-block bg-white rounded-lg px-3 py-1.5">
              <img src="/Logo.png" alt="Lifetime Resettlement Services" className="h-12 w-auto object-contain" />
            </div>
          ...
          {/* Immigration */}
          <div>
            <h4 className="text-white/80 font-semibold text-xs uppercase tracking-wider mb-4">Immigration</h4>
            <ul className="space-y-2.5">
              {immigrationServices.map(({ label, href }) => (
                <li key={label}>
                  <Link to={href} className="text-white/50 text-xs hover:text-white/80 transition-colors">{label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Settlement + Explore */}
          <div>
            <h4 className="text-white/80 font-semibold text-xs uppercase tracking-wider mb-4">Settlement</h4>
            <ul className="space-y-2.5 mb-6">
              {settlementServices.map(({ label, href }) => (
                <li key={label}>
                  <Link to={href} className="text-white/50 text-xs hover:text-white/80 transition-colors">{label}</Link>
                </li>
              ))}
            </ul>
            <h4 className="text-white/80 font-semibold text-xs uppercase tracking-wider mb-4">Explore</h4>
            <ul className="space-y-2.5">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-white/80 font-semibold text-xs uppercase tracking-wider mb-4">Contact</h4>
        ...
        <div className="border-t border-white/10 pt-7 mb-6">
          <div className="bg-black/20 border border-white/10 rounded-xl p-4">
            <p className="text-white/45 text-xs leading-relaxed">
              ...
              CICC regulations and professional standards. Mr. Amalsingh Badal, RCIC — License No: R510526.
              Membre du Registre Québécois des Consultants en Immigration #11570. Verify licence status at{' '}
